...
export default function Seccion_Serv_Rea() {
  ...
  const status = true
  return (
    <div className=" text-black flex flex-col items-center gap-10 bg-pink-200 border-4 rounded-4xl p-8 w-3/4 h-3/4 mt-10 overscroll-contain border-black border-dashed">
      <div>
