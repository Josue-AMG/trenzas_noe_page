...
export default function Seccion_Citas_Pend() {
  const color = "#96D3FF"
  const status = false
  return (
    <div className="text-black flex flex-col backdrop-blur-sm  bg-purple-500/30 items-center gap-10 border-4 rounded-4xl w-3/4 p-8  h-3/4 mt-10 border-black border-dashed">
      <div>
